...
// BACKEND_HOST and CANVA_APP_SHARED_SECRET are normally injected at build
// time by webpack.config.ts's DefinePlugin, which doesn't run under Jest.
(global as unknown as { BACKEND_HOST: string }).BACKEND_HOST = "http://localhost:5000";
(global as unknown as { CANVA_APP_SHARED_SECRET: string }).CANVA_APP_SHARED_SECRET = "test-secret";
